...
<section class="content">
  ...
  <div class="container-fluid">
    <form action="" method="post" name="EditUserForm" id="EditUserForm">
      <div class="card">
        <div class="card-body">								
          <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                <label for="password">Password <i>(optional)</i></label>
                <input type="password" name="password" id="password" class="form-control" placeholder="Password">	
                <span class="text-success">To change password, enter a password otherwise leave blank</span>
                <p></p>
              </div>
            </div>	
            <div class="col-md-6">
